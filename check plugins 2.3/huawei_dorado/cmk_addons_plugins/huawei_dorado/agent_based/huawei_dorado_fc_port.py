...
agent_section_huawei_dorado_fc_port = AgentSection(
    name="huawei_dorado_fc_port",
    parse_function=parse_huawei_dorado,
    parsed_section_name="huawei_dorado_fc_port",
)


def check_huawei_dorado_fc_port(item: str, section: HuaweiAPIData) -> CheckResult:
    '''check FC port state'''
...
check_plugin_huawei_dorado_fc_port = CheckPlugin(
    name="huawei_dorado_fc_port",
    service_name="FC Port %s",
    sections=["huawei_dorado_fc_port"],
    discovery_function=discover_huawei_dorado_items,
    check_function=check_huawei_dorado_fc_port,
)
