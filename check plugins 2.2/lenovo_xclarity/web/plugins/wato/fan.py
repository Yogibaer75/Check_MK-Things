            ...
            (
                ...
                Transform(
                    Tuple(
                        ...
                        elements=[
                            Float(title=_("Warning at"), unit="rpm", default_value=12000),
                            Float(title=_("Critical at"), unit="rpm", default_value=15000),
                        ],
                    ),
            ...
            (
                ...
                Transform(
                    Tuple(
                        ...
                        elements=[
                            Float(title=_("Warning below"), unit="rpm", default_value=300),
                            Float(title=_("Critical below"), unit="rpm", default_value=100),
                        ],
                    ),
                    forth=lambda elems: (float(elems[0]), float(elems[1])),
                ),
