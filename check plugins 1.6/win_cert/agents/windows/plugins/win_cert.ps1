###
## http://blogs.technet.com/b/heyscriptingguy/archive/2006/12/04/how-can-i-expand-the-width-of-the-windows-powershell-console.aspx\r
...
Get-ChildItem -Path cert: -Recurse | ? {($_.Notafter -gt (get-date)) -and ($_.Notafter -lt (get-date).AddDays($expireInDays)) -and ($_.PSPParentPath -notmatch "Disallowed") -and ($blacklist -notcontains $_.Thumbprint) -and ($_.Issuer -match $issuerstring)} | fl subject,Issuer,NotAfter
